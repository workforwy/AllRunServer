...
public class Tools {
    ...
    /*
     * ����һ������������2006-08-22 3���ص��� 2006-08-20 2006-08-21 2006-08-22
     */
    ...
    /**
     * ����һ�������б���2008-06-04 2008-06-05 2008-06-06
     *
     * @param startDateStr
     * @param days
     * @return
     ...
     *
     * @param strUrl
     * @return # ������־�ض����ĵ�λ�� %23 % �������ַ����б��� %25 & �ָ���ͬ�ı���ֵ�� %26 + �ڱ���ֵ�б�ʾ�ո� %2B
     * \ ��ʾĿ¼·�� %2F = �������Ӽ���ֵ %3D ? ��ʾ��ѯ�ַ����Ŀ�ʼ %3F
     */
